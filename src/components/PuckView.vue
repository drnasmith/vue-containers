...
<template>
    <div>
        <div id="puck" class="mt-3 border border-green-500"></div>
    </div>
</template>
...
export default {
    ...
    data: function() {
        return {
            ...
            puckImage: '/puck_no_labels_470x470.png',
      ...
      preparedData: function() {
        ...
        for (var i=0; i<this.samples.length; i++) {
            ...
            if (location && location < samplesArray.length) {
                console.log("Found sample " + i + " in LOCATION: " + location)
  ...
  methods: {
      ...
      drawContainer: function() {
          ...
          this.graphic.selectAll('.sample-cell')
            ...
            .append('circle')
                ...
                .attr('cx', (d,i) => { console.log("X Index: " + i); return this.centres[i][0]} )
                .attr('cy', (d,i) => { console.log("Y Index: " + i); return this.centres[i][1]} )
                .style('fill', 'none')
                .style('stroke', '#666')
      ...
      showLabels: function() {
          ...
          .data(this.centres)
                .enter()
                .append('text')
                .html( (d,i) => { return this.getLabel(i) })
                .attr('x', (d) => {return d[0]})
                .attr('y', (d) => { return d[1]})
